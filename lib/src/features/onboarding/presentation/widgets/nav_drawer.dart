    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          DrawerHeader(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Hola ${widget.sessionData.fullname}',
                  style: TextStyle(
          ...
          Padding(
            padding:
                const EdgeInsets.only(right: 40.0, left: 70.0, bottom: 20.0),
            child: Container(
              height: 1,
              width: 40,
          ...
          Padding(
            padding: const EdgeInsets.only(top: 20.0, right: 40.0, left: 70.0),
            child: Container(
              height: 1,
              width: 40,
              color: AppColors.inputHintColor,
